...
if($type == 'textarea')
{
    ...
    $inputmode = '<select class="form-control @error("'.$col['name'].'") is-invalid @enderror" name="'.$col['name'].'" id="'.$col['name'].'"><option value="" disabled selected">Pilih '.$label.'</option></select>';
    $inputmode_update = '<select class="form-control @error("'.$col['name'].'") is-invalid @enderror" name="'.$col['name'].'" id="'.$col['name'].'"><option value="" disabled selected">Pilih '.$label.'</option><option><?= $edit->'.$col['name'].';?></option></select>';
}else{
